...
function ultimate_constants() {
	...
	define('ULTIMATE_ADMIN_IMAGES_URL', ULTIMATE_ADMIN_URL.'/images');
	define('ULTIMATE_ADMIN_JS_URL', ULTIMATE_ADMIN_URL.'/js');
	define('ULTIMATE_ADMIN_CSS_URL', ULTIMATE_ADMIN_URL.'/css');
...
require_once (ULTIMATE_ADMIN_DIR.'/theme-option.php');
